...
// countries first
var filterCountries = function filterCountries(countries, priorityCountries, whitelist, blacklist, priorityRepeat) {
...
var CountryDropdown = function (_Component) {
	...
	createClass(CountryDropdown, [{
		...
		value: function getCountries() {
			...
			return this.state.countries.map(function (_ref, nr) {
				var _ref2 = slicedToArray(_ref, 2),
				    countryName = _ref2[0],
				    countrySlug = _ref2[1];
		...
		value: function render() {
			...
			var _props3 = this.props,
			    ...
			    priorityRepeat = _props3.priorityRepeat,
			    customOptions = _props3.customOptions,
			    priorityOptions = _props3.priorityOptions,
			    arbitraryProps = objectWithoutProperties(_props3, ['name', 'id', 'classes', 'value', 'onChange', 'onBlur', 'disabled', 'showDefaultOption', 'defaultOptionLabel', 'labelType', 'valueType', 'whitelist', 'blacklist', 'priorityRepeat', 'customOptions', 'priorityOptions']);
